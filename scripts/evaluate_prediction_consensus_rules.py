...
CONSENSUS_RULES = [
    ...
    },
    {
        ...
        "description": "pedigree experiment, near 20 percent coverage with stable fold return",
        "mode": "intersection",
        "base_pred_min": 0.38,
        "secondary_pred_min": 0.30,
        "avg_pred_min": None,
        "odds_min": 3.0,
        "odds_max": 6.0,
        "distance_min": None,
    ...
    {
        "name": "union_mid_25_value",
        "description": "near 25 percent race coverage, medium return",
        "mode": "union",
        "base_pred_min": 0.50,
        "secondary_pred_min": 0.40,
        "avg_pred_min": None,
